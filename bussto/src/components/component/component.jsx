...
export function Component() {
  return (
    (<div className="flex flex-col min-h-screen">
      <header
        className="bg-primary text-primary-foreground py-4 px-6 sm:px-8 md:px-10 flex items-center justify-between">
        <Link
          href="#"
      ...
      <main className="flex-1">
        <section className="bg-muted py-12 md:py-16 lg:py-20">
          <div className="container px-4 md:px-6 lg:px-8">
            <div
              className="grid gap-8 md:grid-cols-2 lg:grid-cols-[1fr_500px] items-center">
